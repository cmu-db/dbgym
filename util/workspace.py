...
def get_workload_name(scale_factor: float | str, seed_start: int, seed_end: int, query_subset: str) -> str:
    return f"workload_sf{get_scale_factor_string(scale_factor)}_{seed_start}_{seed_end}_{query_subset}"
