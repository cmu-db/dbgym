...
def save_file(cfg: DBGymConfig, fpath: os.PathLike):
    ...
    if is_child_path(fpath, cfg.dbgym_runs_path):
        ...
        while not os.path.samefile(parent_dir(parent_dir(parent_dir(org_dpath))), cfg.dbgym_runs_path):
        ...
        this_run_save_dpath = os.path.join(cfg.dbgym_this_run_path, codebase_dname, org_dname)
