...
# embedding
python3 task.py --no-startup-check tune protox embedding datagen tpch queries_15721_15723 --scale-factor 0.01 --default-sample-limit 64 --file-limit 64
# python3 task.py --no-startup-check tune protox embedding datagen tpch queries_15721_15723 --override-sample-limits "lineitem,32768" --scale-factor 0.01
